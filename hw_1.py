input_number = input('Сейчас вам будет продемонстрирован фокус. Какое бы число вы не ввели, ряд арифметических операций превратит его в 4. Итак, начнем. Введите свое число: ')
